...
import { summarizeThread as apiSummarizeThread } from "../../services/aiService.js";
...
export default function Thread() {
  ...
  const handleSummarize = async () => {
    ...
    try {
      const result = await apiSummarizeThread(threadId);
      setSummary(result);
    } catch {
      ...
      <div className="mb-4">
        ...
        {summary && (
          <Card className="mt-3 border-0 bg-light">
            <Card.Body>
              <h6 className="fw-semibold mb-2">AI Summary</h6>
